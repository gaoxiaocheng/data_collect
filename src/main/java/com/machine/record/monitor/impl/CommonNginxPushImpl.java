...
@Service("commonPush")
public class CommonNginxPushImpl implements PushMessage {
    ...
    public void push(String message, String touser, MonitorConfig monitorConfig) {
        ...
        try {
            httpGet = new HttpGet(pushConfig.getPushUrl() + "?pushAgentid="+pushConfig.getPushAgentid()+"&pushSecret="+pushConfig.getPushSecret()+"&touser=" + touser +
